...
$(document).ready(function() {
	...
	$('#nav >  ul > li').hover(function() {
		...
		if($(this).children('ul').text().length!=0) {
				...
				$('#nav   ul  li').removeClass('simple-hover');
				$(this).addClass('hover');
...
<div class="header-container">
            <div  class="wrapper clearfix">
                <h1 class="title">Puy de Dome - Conseil general</h1>
				<a id="logo-header" href="#" onclick="javaScript:goToHome();"> <img alt="" src="imgDesign/logo.png" /> </a>
              
				<div id="topar-header">
					<div id="infoConnection">
						<a target="bottomFrame" href="frameBottom.jsp?FromMySpace=1"><img id="avatar-img" alt="mon avatar" src="/silverpeas<%=helper.getUserDetail().getAvatar()%>" /></a>
						<div class="avatarName">
								<div class="btn-header"><a title="<%=helper.getString("look.banner.profile.title")%>" target="bottomFrame" href="frameBottom.jsp?FromMySpace=1"><%=helper.getUserFullName() %></a>
								<a id="show-menu-spacePerso" href="#"> Mon espace perso</a>
							</div>
							<div class="spacePerso">
							  <ul>
								<li><a target="bottomFrame" href="/silverpeas/RMyProfil/jsp/MySettings"><%=helper.getString("lookSilverpeasV5.profile.settings") %></a> </li>
								<li><a target="bottomFrame" href="frameBottom.jsp?FromMySpace=1"><%=helper.getString("lookSilverpeasV5.profile.myspace") %></a></li>
								<li><a target="bottomFrame" href="/silverpeas/RMyProfil/jsp/Main"><%=helper.getString("lookSilverpeasV5.profile.feed") %></a></li>
								<li><a id="logOut-link" target="_top" href="/silverpeas/LogoutServlet"><%=helper.getString("look.banner.logout") %></a> </li>
							  </ul>
							</div>
						</div>
						| <div id="notification-count" class="btn-header">
							<a href="<%=m_sContext %>/RSILVERMAIL/jsp/Main" target="bottomFrame"><span>...</span> <span id="notification-label">notifications</span></a>
						 </div>
						|
					...
					<ul id="outils">
						...
						<li id="directory-link-header"><a target="bottomFrame" href="/silverpeas/Rdirectory/jsp/Main" title="<%=helper.getString("look.banner.directory") %>"><%=helper.getString("look.banner.directory") %></a></li>
                ...
                <div id="nav">
                    <ul>
                        <li class="selected">
							<a href="#" onclick="javaScript:goToHome();"><span><%=helper.getString("look.banner.home") %></span></a>
						</li>
